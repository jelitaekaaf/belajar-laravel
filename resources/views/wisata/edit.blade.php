...
<body>
    ...
    <nav class="navbar navbar-inverse  navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right navbar-top-links">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-sign-out fa-fw"></i> Jelita <b class="caret"></b>
                </a>
                      ...
                      <div class="card-body">
                        ...
                        @method('PUT')  
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="id_kategori" value="{{$wisata->id_kategori}}">
                            <label class="form-label">Lokasi</label>
                            <input type="text" class="form-control" name="id_lokasi" value="{{$wisata->id_lokasi}}">    
                            <label class="form-label">Deskripsi</label>
                            <input type="text" class="form-control" name="deskripsi" value="{{$wisata->deskripsi}}"> 
                            <label class="form-label">Event</label>
                            <input type="text" class="form-control" name="id_event" value="{{$wisata->id_event}}"> 
                            <label class="form-label">Image</label>
                            <input type="file" class="form-control" name="cover" value="{{$wisata->cover}}"> 
                           ...
                           --}}
                            ...
                            <a href="{{url('/wisata')}}" class="btn btn-success">Back</a>     
