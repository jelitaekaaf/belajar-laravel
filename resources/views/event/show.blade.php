...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Show Data Event</h1>
                </div>
            </div>
                        ...
                        <div class="card-body">
                          <form action="" method="POST">
                            <div class="mb-3">
                              ...
                              <input type="date" class="form-control" name="tgl" value="{{$event->tgl}}" disabled>
                              <label class="form-label"> Lokasi </label>
                              <input type="text" class="form-control" name="id_lokasi" value="{{$event->id_lokasi}}" disabled>
