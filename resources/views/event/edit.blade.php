...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Data Event</h1>
                </div>
            </div>
                      ...
                      <div class="card-body">
                        ...
                        @method('PUT')  
                          <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="tgl" value="{{$event->tgl}}">
                            <label class="form-label">Lokasi</label>
                            <input type="text" class="form-control" name="id_lokasi" value="{{$event->id_lokasi}}">
                           ...
                           --}}
                            ...
                            <a href="{{url('/event')}}" class="btn btn-success">Back</a>   
                          </form>
                     </div>
                  </div>
              </div>
